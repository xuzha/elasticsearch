...
public class RepositoryS3SettingsTests extends ESTestCase {
    ...
    public void testRepositorySettingsGlobalOnly() {
        ...
        assertThat(getValue(repositorySettings, Repository.CLIENT_SYMMETRIC_KEY, Repositories.SYMMETRIC_KEY_SETTING), isEmptyString());
        assertThat(getValue(repositorySettings, Repository.CLIENT_PRIVATE_KEY, Repositories.PRIVATE_KEY_SETTING), isEmptyString());
        assertThat(getValue(repositorySettings, Repository.CLIENT_PUBLIC_KEY, Repositories.PUBLIC_KEY), isEmptyString());
    }
