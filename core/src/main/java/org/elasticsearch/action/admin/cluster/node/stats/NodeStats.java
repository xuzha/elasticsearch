...
public class NodeStats extends BaseNodeResponse implements ToXContent {
    ...
    @Nullable
    private ClusterStateQueueStats clusterStateQueueStats;
    ...
    public NodeStats(DiscoveryNode node, long timestamp, @Nullable NodeIndicesStats indices,
                     ...
                     @Nullable ClusterStateQueueStats clusterStateQueueStats) {
        super(node);
        ...
        this.clusterStateQueueStats = clusterStateQueueStats;
    }
    ...
    @Nullable
    public ClusterStateQueueStats getClusterStateQueueStats() {
        return this.clusterStateQueueStats;
    }
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        clusterStateQueueStats = in.readOptionalStreamable(new ClusterStateQueueStats());
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeOptionalStreamable(clusterStateQueueStats);
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (getClusterStateQueueStats() != null) {
            getClusterStateQueueStats().toXContent(builder, params);
        }
